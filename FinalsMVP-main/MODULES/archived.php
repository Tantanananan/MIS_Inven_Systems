                ...
                <div class="container-fluid">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item d-none d-sm-inline-block ms-2">
                            <span class="nav-link font-weight-bold text-light p-0">User Archives</span>
                        </li>
                    </ul>
                </div>
            </nav>
                ...
                <div class="card border-0 shadow-sm card-green-theme">
                    <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                        <h6 class="mb-0 text-dark fw-bold">
                            <i class="bi bi-person-dash me-2"></i> Archived Users
                        </h6>
                    </div>
                            ...
                            <tbody>
                                <?php if ($result && $result->num_rows > 0): ?>
                                    <?php while($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            <td class="ps-4 fw-bold text-dark"><?php echo htmlspecialchars($row['full_name']); ?></td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="text-center py-5 text-muted">
                                            <i class="bi bi-person-x fs-2 d-block mb-2 text-light-muted"></i>
