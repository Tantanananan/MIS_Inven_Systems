        ...
        <div class="content-wrapper" id="mainContent">
                ...
                <div class="container-fluid">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item d-none d-sm-inline-block ms-2">
                            <span class="nav-link font-weight-bold text-light p-0">Admin Dashboard</span>
                        </li>
                    </ul>
            ...
            <div class="container-fluid p-4">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <form action="../ACTIONS/process_borrow.php" method="POST" class="row g-3 align-items-end">
                            <div class="col-md-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="../ACTIONS/process_return.php?tid=<?php echo $row['transaction_id']; ?>" class="btn btn-sm btn-outline-primary border-1 px-3">One-Click Return</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
