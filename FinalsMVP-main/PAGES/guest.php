...
<head>
    ...
    <style>
        ...
        .hero-title { font-weight: 700; font-size: 2.5rem; }
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <p class="hero-subtitle mb-0">Browse real-time availability of school equipment. Login is required to process transactions.</p>
                </div>
                <div class="col-lg-4 text-center text-lg-end">
                    <i class="bi bi-laptop text-white opacity-50" style="font-size: 6rem;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container flex-grow-1 mb-5">
        <div class="row mb-5">
            ...
            <div class="col-md-4">
                <div class="card stat-card shadow-sm h-100">
                    <div class="card-body d-flex align-items-center p-4">
                        <div class="flex-shrink-0 bg-warning-subtle p-3 rounded-3 text-warning me-4">
                            <i class="bi bi-exclamation-triangle-fill fs-2"></i>
                        </div>
                        <div>
                            <h6 class="mb-1 text-muted text-uppercase fw-bold" style="font-size: 0.8rem;">Defective</h6>
                ...
                <table class="table table-hover align-middle mb-0 bg-white" id="inventoryTable">
                    ...
                    <tbody>
                        <?php if ($result && $result->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr><td colspan="5" class="text-center py-5 text-muted">No equipment found.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
