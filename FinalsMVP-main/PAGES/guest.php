...
<head>
    ...
    position: relative;
    background-color: #588157; /* Your primary color */
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8 text-center text-lg-start mb-4 mb-lg-0">
                    ...
                    <p class="hero-subtitle mb-4">Browse real-time availability of school equipment. Login is required to process transactions.</p>
